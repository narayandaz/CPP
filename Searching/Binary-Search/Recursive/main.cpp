...
int BinarySearch(const int ArrayName[], const int ArraySize,
                 const int SearchKey, const int FromIndex, const int ToIndex) {
  ...
  if (ToIndex - FromIndex == 1) {
    ...
    if (SearchKey == ArrayName[MidIndex])
      ...
      SearchResult =
          BinarySearch(ArrayName, ArraySize, SearchKey, FromIndex, MidIndex);
    else if (SearchKey < ArrayName[MidIndex])
      SearchResult =
          BinarySearch(ArrayName, ArraySize, SearchKey, MidIndex, ToIndex);
  }
